    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('welcome') ?>">
                ...
                <div class="sidebar-brand-text mx-3">Pembelajaran Online</div>
            </a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('category/programming') ?>">
                    <!--<i class="fas fa-fw fa-toolbox"></i>-->
                    <span>Programming</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('category/bahasa') ?>">
                    <span>Bahasa</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('category/bisnis') ?>">
                    <span>Bisnis</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('category/desain') ?>">
                    <span>Desain</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('category/lainnya') ?>">
                        ...
                        <div class="navbar">
                            <ul class="nav navbar-nav navbar-right">
                                <li>
                                    ...
                                    <?= anchor('dashboard/cart_detail', $cart) ?>
                                </li>
                            </ul>
